...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange, hasDataset }) => {
  ...
  return (
    <aside className="w-full md:w-60 border-r-0 md:border-r border-b md:border-b-0 border-emerald-900/80 bg-[#0a1510] flex flex-col justify-between py-3 md:py-4 px-3 select-none text-xs">
              ...
              {section.items.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {item.badge && (
                      <span
                        className={`text-[9px] font-mono px-1.5 py-0.2 rounded whitespace-nowrap ${
      ...
      <div className="hidden md:block p-3 rounded-lg bg-emerald-950/60 border border-emerald-900 text-[11px] text-slate-400 space-y-1 font-mono">
